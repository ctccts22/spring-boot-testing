...
//                .willReturn(employee);
    ...
    @DisplayName("JUnit test for updatedEmployee")
    @Test
    public void givenEmployeeObject_whenUpdateEmployee_thenReturnUpdatedEmployee() {
        ...
        // then - verify the output
        assertThat(updatedEmployee.getEmail()).isEqualTo("kim@gmail.com");
        assertThat(updatedEmployee.getFirstName()).isEqualTo("kim");
    }
